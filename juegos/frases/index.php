...
<body>
  <h1>Juego de frases</h1>
  <div id="game">
    <p id="wordDisplay"></p>
    <p>Errores: <span id="mistakes">0</span> / 4</p>
    <p>Letras usadas: <span id="usedLetters"></span></p>
    <div id="keyboard"></div>
    <p id="message"></p>
  ...
  <div class="volver">
    <a href="../../">
      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#ff9500"
