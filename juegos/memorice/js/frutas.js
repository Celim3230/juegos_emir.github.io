...
// Imagenes de frutas
let img1 = [
  (innerHTML = `<div><img src="../img/frutas/img1.png" width='150'></div>`),
];
let img2 = [
  (innerHTML = `<div><img src="../img/frutas/img2.png" width='150'></div>`),
];
let img3 = [
  (innerHTML = `<div><img src="../img/frutas/img3.png" width='150'></div>`),
];
let img4 = [
  (innerHTML = `<div><img src="../img/frutas/img4.png" width='150'></div>`),
];
let img5 = [
  (innerHTML = `<div><img src="../img/frutas/img5.png" width='150'></div>`),
];
let img6 = [
  (innerHTML = `<div><img src="../img/frutas/img6.png" width='150'></div>`),
];
let img7 = [
  (innerHTML = `<div><img src="../img/frutas/img7.png" width='150'></div>`),
];
